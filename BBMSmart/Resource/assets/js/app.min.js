...
(APP = new (APP = function () {
    ...
    $(".metismenu").metisMenu(), $('[data-toggle="tooltip"]').tooltip(), $('[data-toggle="popover"]').popover(), $(".scroller").each(function () {
        ...
        if ($(".page-sidebar").width() <= 96) {
            $("body").addClass("tabMenu")
            // $(".fixedHeader-floating").css("left", "242.172px")
            // $(".fixedHeader-floating").css("width", " " + $("#tbl_Item").width() + "px !important;")
        }
        else {
            $("body").removeClass("tabMenu")
...
//    if (parseInt($("html").width()) <= 1400) {
//        $('.sidebar-toggler').css({ "pointer-events": "none", "opacity": "0.6", });
//    }
//    else {
//        $(".sidebar-toggler").css("pointer-events", "initial");
//        $(".sidebar-toggler").css("opacity", "1");
//    }
